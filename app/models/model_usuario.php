...
//requindo o arquivo para se conectar com o banco
require_once(realpath(dirname(__FILE__) . '/../config/connect.php'));

//criando a class herdada da class connect
class model_usuario extends connect
{
    ...
    {
        //chamando o construtor da class conect para ser chamada no contrutor do model
        parent::__construct();
        $this->tables = '';
    }
